...
<div class="containerP">
    ...
    <form method="POST" action="">
      ...
      <p>
          ...
          <br>
        <input type="number" name="user_id" value="<?php echo $id; ?>" required>
        <br>
      ...
      <p>HEREDO FAMILIARES<br>
        ...
        <input name="heredo_familiares" type="text">
      </p>
      <p>NO PATOLÓGICOS<br>
      ...
      <p>PATOLÓGICAS<br>
        ...
        <input name="otras_patologias" type="text">
      </p>
      <p>PADECIMIENTO ACTUAL<br>

        <label>Padecimiento Actual<label>
        <input name="padecimiento_act" type="text">
      </p>
      <p>APARATOS Y SISTEMAS<br>
        ...
        <label>Notas<label>
        <input name="notasdos" type="text">
      </p>
      <p>EXPLORACIÓN FÍSICA<br>
        ...
        <input name="piel_anexos" type="text">
      </p>
      <p>ESTUDIOS DE LABORATORIO,GABINETE Y OTROS<br>
      ...
      <p>DIAGNÓSTICO<br>
        ...
        <input name="diag_probclinicos" type="text">
      </p>
      <p>PRONÓSTICO<br>

        <label>Pronóstico<label>
        <input name="pronostico" type="text">
      </p>
      <p>INDICACIÓN TERAPÉUTICA<br>

        <label>Indicación Terapéutica<label>
        <input name="indic_terapeutica" type="text">
      </p>
      <p>ADICIONALES<br>
